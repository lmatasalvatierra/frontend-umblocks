...
import { POLICY_SUBMIT, POLICY_VIEW, POLICIES_SUMMARIES } from '../constant/ActionTypes';
...
export function gettingPoliciesSummaries(userid) {
  return async function damsmsa(dispatch) {
