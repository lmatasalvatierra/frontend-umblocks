...
/*
 * Used to identify the application version (git hash + version) that can be used
 * in several places to classify events. For example is sent to the error tracking
 * in Rollbar as part of the payload.
 */
